...
public class TilesPairwiseOverlapTest {
	...
	public void test1d() {
		...
		t2.setStagePosition( new double[] { 5. } ); t2.setSize( new long[] { 2 } );
		Assert.assertNull( TileOperations.getOverlappingRegion( t1, t2 ) );
		Assert.assertNull( TileOperations.getOverlappingRegion( t2, t1 ) );

		// no intersection
		t1.setStagePosition( new double[] { 100. } ); t1.setSize( new long[] { 1 } );
		t2.setStagePosition( new double[] { 500. } ); t2.setSize( new long[] { 1 } );
		Assert.assertNull( TileOperations.getOverlappingRegion( t1, t2 ) );
		Assert.assertNull( TileOperations.getOverlappingRegion( t2, t1 ) );
	}
	...
	public void test2d() {
		...
		t2.setStagePosition( new double[] { 3., 2. } ); t2.setSize( new long[] { 2, 5 } );
		Assert.assertNull( TileOperations.getOverlappingRegion( t1, t2 ) );
		Assert.assertNull( TileOperations.getOverlappingRegion( t2, t1 ) );

		// intersection (point)
		t1.setStagePosition( new double[] { 0., 0. } ); t1.setSize( new long[] { 3, 4 } );
		t2.setStagePosition( new double[] { 3., 4. } ); t2.setSize( new long[] { 2, 5 } );
		Assert.assertNull( TileOperations.getOverlappingRegion( t1, t2 ) );
		Assert.assertNull( TileOperations.getOverlappingRegion( t2, t1 ) );

		// no intersection
		t1.setStagePosition( new double[] { 0., 0. } );  t1.setSize( new long[] { 5, 6 } );
		t2.setStagePosition( new double[] { 2., 10. } ); t2.setSize( new long[] { 3, 4 } );
		Assert.assertNull( TileOperations.getOverlappingRegion( t1, t2 ) );
		Assert.assertNull( TileOperations.getOverlappingRegion( t2, t1 ) );
	}
	...
	public void test3d() {
		...
		// intersection
		t1.setStagePosition( new double[] { 0., 0., 0. } ); t1.setSize( new long[] { 3, 4, 5 } );
		t2.setStagePosition( new double[] { 3., 4., 5. } ); t2.setSize( new long[] { 1, 2, 3 } );
		Assert.assertNull( TileOperations.getOverlappingRegion( t1, t2 ) );
		Assert.assertNull( TileOperations.getOverlappingRegion( t2, t1 ) );

		// no intersection
		t1.setStagePosition( new double[] { 0., 0., 0. } );  t1.setSize( new long[] { 3, 4, 5 } );
		t2.setStagePosition( new double[] { 1., 2., 10. } ); t2.setSize( new long[] { 3, 4, 5 } );
		Assert.assertNull( TileOperations.getOverlappingRegion( t1, t2 ) );
		Assert.assertNull( TileOperations.getOverlappingRegion( t2, t1 ) );
	}
}
