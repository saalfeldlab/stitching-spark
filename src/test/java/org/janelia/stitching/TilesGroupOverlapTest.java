...
public class TilesGroupOverlapTest {
	...
	public void test() {
		...
		tiles[ 0 ].setPosition( new double[] { 0., 0., 0. } ); 													tiles[ 0 ].setSize( new long[] { 991, 992, 880 } );
		tiles[ 1 ].setPosition( new double[] { 716.932762003862, -694.0887500300357, -77.41783189603937 } );	tiles[ 1 ].setSize( new long[] { 991, 992, 953 } );
		tiles[ 2 ].setPosition( new double[] { 190.0026915705376, -765.0362103552288, -79.91642981085911 } );  	tiles[ 2 ].setSize( new long[] { 991, 992, 953 } );
