...
public class PairwiseStitching
{
			...
			final ExecutorService service)
	{
		...
		System.out.println( "1: " + ImgLib2Util.printRealInterval( transformed1 ) );
		System.out.println( "2: " + Util.printInterval( img2 ) );
		System.out.println( "2: " + ImgLib2Util.printRealInterval( transformed2 ) );

		final RealInterval overlap = TransformTools.getOverlap( transformed1, transformed2 );
		System.out.println( "O: " + ImgLib2Util.printRealInterval( overlap ) );
		...
		System.out.println( "1: " + ImgLib2Util.printRealInterval( localOverlap1 ) );
		System.out.println( "1: " + Util.printInterval( interval1 ) );
		System.out.println( "2: " + ImgLib2Util.printRealInterval( localOverlap2 ) );
		...
		// do the alignment
		final Align< T > lkAlign = new Align< T >( Views.zeroMin( Views.interval( img1, interval1 ) ),
			...
			final ExecutorService service)
	{
		...
		try {
			final ImagePlus pcmImp = Utils.copyToImagePlus( pcm );
			pcmImp.setTitle("PCM-new");
			pcmImp.show();
	...
	public static float min( final RandomAccessibleInterval< FloatType > img, final ExecutorService taskExecutor )
	{
		...
		final Vector< ImagePortion > portions = PhaseCorrelation2Util.divideIntoPortions( iterable.size() );
