...
public class LucasKanadeParameters
{
	...
	public LucasKanadeParameters(final WarpFunctionType modelType, final int maxNumIterations, final double minParameterChange, final boolean showExpertGrouping)
	{
	 ...
	 */
	public LucasKanadeParameters(final WarpFunctionType modelType)
	{
	 ...
	 */
	public WarpFunction getWarpFunctionInstance(final int numDimensions)
	{
...
//			return new RigidWarp( numDimensions );
	...
	public static void addQueriesToGD(final GenericDialog gd, final boolean askForModelType)
	{
	...
	public static LucasKanadeParameters getParametersFromGD(final GenericDialog gd, final boolean askForModelType)
	{
		if (gd.wasCanceled())
			return null;
		...
		final boolean expertGrouping = gd.getNextBoolean();
	...
	public static LucasKanadeParameters askUserForParameters(final boolean askForModelType)
	{
		// ask user for parameters
		final GenericDialog gd = new GenericDialog("Pairwise stitching options");
	...
	{
		final LucasKanadeParameters params = askUserForParameters(false);
