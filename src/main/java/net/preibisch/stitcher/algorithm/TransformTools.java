...
public class TransformTools {
	...
	public static boolean isOnlyScaleAndTranslation(final AffineGet tr)
	{
	...
	public static Pair<AffineGet, AffineGet> decomposeIntoAffineAndTranslation(final AffineGet tr)
	{
		...
		t.set( 0, 1, 3 );
		t.set( 0, 2, 3 );
		final AffineTransform3D tt = new AffineTransform3D();
		tt.set( tr.get( 0, 3 ), 0, 3 );
		tt.set( tr.get( 1, 3 ), 1, 3 );
		tt.set( tr.get( 2, 3 ), 2, 3 );

		return new ValuePair< >( t, tt );
	}
	public static AffineTransform3D mapBackTransform(final AffineGet to, final AffineGet from)
	{
		...
		final AffineModel3D mapBackModel = new AffineModel3D();
	...
	public static Pair<AffineGet, TranslationGet> getInitialTransforms( final ViewRegistration vr, final boolean is2d, final AffineTransform3D dsCorrectionT )
	{
		...
		final AffineTransform3D modelWithoutTranslation = model.copy();
	 ...
	 */
	public static boolean allAlmostEqual(final double[] a, final double[] b, final double eps)
	{
	...
	public static FinalRealInterval applyTranslation(final RealInterval img, final TranslationGet translation, final boolean[] ignoreDims){
	 ...
	 */
	public static FinalRealInterval getLocalOverlap(final RealInterval img, final RealInterval overlap){
	 ...
	 */
	public static FinalInterval getLocalRasterOverlap(final RealInterval overlap)
	{
	...
	public static void main(final String[] args)
	{
		...
		final AffineTransform3D conc = scale.copy().preConcatenate( translate );
		scale.scale( 3.0 );
		final AffineTransform3D conc2 = scale.copy().preConcatenate( translate2 );
		...
		conc.apply( p1, p1 );
		final RealPoint p2 = new RealPoint( 3 );
		conc2.apply( p2, p2 );

		System.out.println( p1 );
		System.out.println( p2 );

		final AffineTransform3D everythingbuttraslation = conc.copy();
		everythingbuttraslation.set( 0, 0, 3 );
		everythingbuttraslation.set( 0, 1, 3 );
		everythingbuttraslation.set( 0, 2, 3 );

		final AffineTransform3D everythingbuttraslation2 = conc2.copy();
		everythingbuttraslation2.set( 0, 0, 3 );
		everythingbuttraslation2.set( 0, 1, 3 );
		everythingbuttraslation2.set( 0, 2, 3 );

		final double[] trans1 = conc.getTranslation();
		final double[] trans2 = conc2.getTranslation();
