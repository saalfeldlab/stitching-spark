...
public class TransformedTileOperations
{
			...
			final TileSearchRadiusEstimator searchRadiusEstimator ) throws PipelineExecutionException, NotEnoughNeighboringTilesException
	{
		...
		Arrays.fill( subTilesGridSize, searchRadiusEstimator.getSubdivisionGridSize() );
		...
		{
			final Collection< SubTile > neighboringSubTiles = searchRadiusEstimator.findSubTilesWithinWindow( subTile );
			final List< PointMatch > pointMatches = new ArrayList<>();
			for ( final SubTile neighboringSubTile : neighboringSubTiles )
			{
				final double[] neighboringSubTileMiddlePointStagePosition = SubTileOperations.getSubTileMiddlePointStagePosition( neighboringSubTile );
				final double[] neighboringSubTileMiddlePointWorldPosition = TransformedTileOperations.transformSubTileMiddlePoint( neighboringSubTile, true );
