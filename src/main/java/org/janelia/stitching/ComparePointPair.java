...
public class ComparePointPair
{
	...
	public void setTileBoxPair( final TileBoxPair tileBoxPair ) { this.tileBoxPair = tileBoxPair; }
	public TileBoxPair getTileBoxPair() { return tileBoxPair; }
}
