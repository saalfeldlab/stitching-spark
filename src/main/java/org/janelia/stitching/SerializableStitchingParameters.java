...
// taken from mpicbg.stitching to conform with the old phase correlation code

public class SerializableStitchingParameters implements Serializable
{
	private static final long serialVersionUID = -1679284178598052742L;
